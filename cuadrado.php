		...
		<section id="servicios" class="sección">
			<div  class="container">
				<div class="row">
					<div class=" columna33 columna-mobile-100">
						<div class="bloque-servicio">
							...
							<div id="def" class="bloque-contenido-servicio">
								<h3>Cuadrado</h3>
								<p>Es un paralelogramo de los más conocidos ya que tiene cuatro lados iguales que forman cuatro ángulos rectos, tiene solo dos diagonales y sus ángulos internos suman 360°.</p>
					...
					<iframe  width="1366" height="736"src="https://www.youtube.com/embed/lQ1KBjP_N3I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</section>
